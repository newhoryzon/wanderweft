...
import com.nhoryzon.mc.adventurerspaths.registry.*;
...
public class AdventurersPathsMod implements ModInitializer {

    public static final Logger LOGGER = LoggerFactory.getLogger("Adventurers' Paths");
    public static final String MOD_ID = "adventurerspaths";
