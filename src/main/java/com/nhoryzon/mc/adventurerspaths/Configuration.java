package com.nhoryzon.mc.adventurerspaths;
...
public final class Configuration {
    ...
    private static final File CONFIG_FILE = new File(FabricLoader.getInstance().getConfigDir().toFile(), "adventurerspaths.json");
    ...
    public static Configuration load() {
        ...
        try {
            ...
            AdventurersPathsMod.LOGGER.error("Error while trying to load configuration file. Default configuration used.", e);
        }
    ...
    public static void save(Configuration config) {
        try {
            ...
            AdventurersPathsMod.LOGGER.error("Error while trying to save configuration file.", e);
        }
    }
